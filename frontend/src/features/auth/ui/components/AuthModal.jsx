...
const AuthModal = () => {
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={handleClose} maxWidth="max-w-md" padding="p-4 sm:p-5">
      ...
      {/* Login Form */}
      <form onSubmit={handleSubmit(handleLogin)} className="space-y-2.5">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-xs focus:outline-none focus:ring-2 focus:ring-[#1a73e8]"
        ...
        <div className="flex items-center justify-between text-[11px] pt-0.5">
          <label className="flex items-center gap-1.5 cursor-pointer text-slate-600 dark:text-slate-400">
            <input
              type="checkbox"
              {...register("rememberMe")}
              className="w-3.5 h-3.5 rounded text-[#1a73e8] focus:ring-[#1a73e8]"
            />
