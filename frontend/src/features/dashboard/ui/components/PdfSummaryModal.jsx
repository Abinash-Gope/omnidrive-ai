...
const PdfSummaryModal = ({ file, isOpen, onClose }) => {
  ...
  const summary = file.summary || {
    executive:
      "This document provides a comprehensive technical review of high-throughput distributed serverless systems, outlining zero-server maintenance paradigms, direct S3 streaming architectures, and auto-scaling OCR workers.",
    takeaways: [
      "Sub-second S3 direct upload latency achieved by offloading from Node/Python servers.",
      "Amazon Textract accurately vectorized multi-column PDF layouts without manual template tagging.",
      "Amazon Bedrock (Claude 3 Haiku) extracted synthesized executive briefs in 1.2 seconds.",
      "DynamoDB single-table indexing maintains fast read latency under high concurrent load.",
    ],
